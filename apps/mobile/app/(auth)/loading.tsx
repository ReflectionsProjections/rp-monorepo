                ...
                if (jwt) {
                    ...
                    if (isValid) {
                        ...
                        if (roles.length > 0) {
                            ...
                            Alert.alert(
                                "Make sure to register for the event first!",
                            )
    ...
    return (
        <View className="flex-1 justify-center items-center bg-white p-5">
            <Text className="text-center font-proRacing mb-10">
                <Text className="text-[32px] font-bold text-black tracking-[2px]">
                    reflections
                </Text>
                {"\n"}
                <Text className="text-[32px] font-bold text-[#F0363D] tracking-[2px]">
                    projections
                </Text>
            </Text>
            ...
            <View className="w-4/5 h-3 bg-[#EEEEEE] rounded-md overflow-hidden mb-4">
                <Animated.View
                    className="h-full bg-[#F0363D] rounded-md"
                    style={{ width }}
                />
            </View>
