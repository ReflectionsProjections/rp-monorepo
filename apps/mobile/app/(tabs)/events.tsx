                            ...
                            >
                                <LinearGradient
                                    colors={[
                                        "#FFFFFF00",
                                        typeColors[
                                            item.eventType as keyof typeof typeColors
                                        ],
                                    ]} // Use your event type color and a secondary color
                                    start={{ x: 0, y: 0 }}
                                    end={{ x: 0.5, y: 0 }}
                ...
                >
                    <Animated.View
                        style={{
                            ...
                            top:
                                SCREEN_HEIGHT / 2 -
                                (SCREEN_HEIGHT * 0.75) / 1.3,
                            left:
                                SCREEN_WIDTH / 2 - (SCREEN_WIDTH * 0.85) / 1.7,
                            width: "100%",
                            height: "100%",
                    ...
                    >
                        ...
                        >
                            <BadgeSvg
                                ...
                                color={
                                    typeColors[
                                        selectedEvent?.eventType as keyof typeof typeColors
                                    ]
                                }
                            />
