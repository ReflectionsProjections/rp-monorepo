...
export default function DayEvent({
    ...
    const websiteStyles = {
        ...
        spacing: {
            grid: {
                ...
                gap: 3,
                templateColumns: {
                    base: "25px 8px 1fr 40px",
                    md: "40px 8px 1fr 40px",
                },
            },
            icon: {
                size: 6,
    ...
    return (
        <Grid
            ...
            borderRadius={
                isDashboard && selected ? styles.borderRadius : undefined
            }
            _first={{
        ...
        >
            ...
            <Flex flexDirection={"column"} gap={0} width={"fit-content"}>
                ...
                <Flex
                    flexDirection={
                        isDashboard ? "row" : { base: "column", md: "row" }
                    }
                    gap={0}
                    width={"fit-content"}
                >
