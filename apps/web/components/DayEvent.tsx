...
export default function DayEvent({
    ...
    const isSueKeynote =
        event.name.toLowerCase().includes('sue') && event.eventType.toLowerCase() === 'speaker';
    ...
    return (
        ...
        >
            ...
            <Box
                ...
                justifyContent={'center'}
                alignItems={'center'}
                w={isDashboard ? styles.lineWidth : { base: '4px', md: styles.lineWidth }}
            ...
            <Flex flexDirection={'column'} gap={0} width={'fit-content'}>
                ...
                >
                    ...
                    <Text
                        ...
                        letterSpacing={isDashboard ? '0.05vh' : '0.5px'}
                        transformOrigin={'top left'}
                        whiteSpace={isDashboard ? 'nowrap' : { base: 'normal', md: 'nowrap' }}
                    >
            ...
            <Tooltip
                label={event.eventType.toLowerCase().replace(/^\w/, (c) => c.toUpperCase())}
                fontFamily="Magistral"
            ...
            >
                ...
                >
                    <Icon
                        ...
                        filter={
                            isSueKeynote ? 'drop-shadow(0 0 8px rgba(255, 215, 0, 0.8))' : 'none'
                        }
                    />
                </Flex>
            </Tooltip>
