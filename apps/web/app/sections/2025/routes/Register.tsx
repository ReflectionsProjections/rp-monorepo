...
const RegisterForm: React.FC<RegisterFormProps> = ({ children }) => {
    ...
    useFormAutosave<RegistrationValues>(() => {
        toast({
...
const Register = () => {
    ...
    const Background = () => {
        ...
        const image1Opacity = useTransform(scrollYProgress, [0, 0.5], [finalOpacity, 0]);
        const image2Opacity = useTransform(scrollYProgress, [0.5, 1], [0, finalOpacity]);
    ...
    const ProgressBar = () => {
        ...
        const progress = useTransform(width, (v) => `calc(${v * 100}% + ${initialProgress})`);
    ...
    const ConfirmationScreen = () => (
        ...
        >
          ...
          style={{ height: 200 }}
        /> */}
                <Heading size="3xl" fontFamily="Magistral" color="white" textAlign="center">
                    Thank you for registering!
                </Heading>
                <Text fontSize="2xl" fontFamily="Magistral" color="white" textAlign="center">
                        ...
                        {values && (
                            <Formik
                                ...
                                onSubmit={(values, helpers) => {
                                    setIsLoading(true);
                                    processFinalRegistration(values);
                                    toast({
                                        title: 'This Form Has Closed',
                                        status: 'error',
                                        duration: 9000,
