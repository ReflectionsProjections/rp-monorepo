...
export default function AppScreen() {
    ...
    return (
        <Box minH="100vh" w="100%" pos="relative" overflow="hidden" bg="black">
            {/* Background SVG */}
            <Box pos="absolute" top="0" left="0" w="100%" h="100%" zIndex={1} opacity={0.9}>
                <Image
                    src="/site/appscreen/app_bg.svg"
                    alt="App Background"
                    w="100%"
                    h="100%"
                    objectFit="cover"
                ...
                <Container maxW="container.xl" px={6}>
                    <VStack spacing={8} textAlign="center" color="white" py={20}>
                        ...
                        <Text
                            ...
                            opacity={0.9}
                        >
                            Experience Reflections | Projections like never before with our mobile
                            app. Stay connected, track your progress, and never miss an update.
                        </Text>
