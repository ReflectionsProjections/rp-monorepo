import { Box, Flex, HStack, Image, Spacer, Text, useToast } from '@chakra-ui/react';
...
const EventsData: Event[] = [
    ...
    },
    {
        ...
        points: 15,
        description:
            'Join us for our keynote speaker, the founder and CEO of Rewriting The Code! Sue will be discussing the current state of the tech industry and how to prepare for its future.',
        isVirtual: false,
        imageUrl: 'https://google.com',
        ...
        attendanceCount: 35,
        eventType: 'SPEAKER',
        tags: ['Career Readiness', 'Networking'],
    },
    {
    ...
    },
    {
        ...
        points: 10,
        description:
            'Join us for our collaboration event with Women in Computer Science! Sue Harnett, the founder of Rewriting The Code and our keynote speaker, will be hosting an informal networking and advice session. Ask Sue questions, meet people, and learn strategies for navigating the tech industry as someone from an underrepresented background. Brunch will also be served!',
        isVirtual: false,
        imageUrl: 'https://google.com',
        location: 'Siebel 2405',
        isVisible: true,
        attendanceCount: 18,
        eventType: 'PARTNERS',
        tags: ['Career Readiness', 'Networking', 'Interactive Events'],
    },
    {
        ...
        points: 15,
        description:
            'Step into the future of creativity!  Join Michael Schrenk, Josh Antonuccio, Sharath Ramakrishnan, and Eliot Chang as they dive into how AI is transforming art, music, games, and storytelling—revealing the risks, rewards, and what creativity will mean in the age of AI.',
        isVirtual: false,
        imageUrl: 'https://google.com',
        location: 'Siebel 2405',
        isVisible: true,
        attendanceCount: 48,
        eventType: 'SPECIAL',
        tags: ['AI', 'Interactive Events', 'Art/Media'],
    },
    {
    ...
    },
    {
        ...
        points: 10,
        description:
            'Competitive Intelligence discovers competitive advantages from information that other organizations either ignore, or don’t have the wherewithal to process. This talk describes techniques and stories from thirty years in the field.',
        isVirtual: false,
        imageUrl: 'https://google.com',
        location: 'Siebel 2405',
        isVisible: true,
        attendanceCount: 13,
        eventType: 'SPEAKER',
        tags: ['Ethics', 'Research', 'Cybersecurity'],
    },
    {
        ...
        points: 5,
        description:
            'Join us at the starting line of Reflections | Projections 2025! We’ll take a lap through the history of R|P and give you a preview of the exciting week ahead. The R|P Grand Prix starts here!',
        isVirtual: false,
    ...
    },
    {
        ...
        points: 15,
        description:
            'Hudson River Trading is excited to be at UIUC! We’re hosting a tech talk with R|P, and we’d love for you to join us to learn more about HRT. You’ll hear directly from HRTers across our software engineering and hardware engineering teams as they share insights into their work and career paths. Food and swag will be provided!',
        isVirtual: false,
        imageUrl: 'https://google.com',
        location: 'Siebel 2405',
        isVisible: true,
    ...
    },
    {
        ...
        points: 10,
        description:
            "Enjoy escape rooms? Well, do we have the thing for you! Gather your team of 2-4 gamers, solve the puzzles, unlock the locks, and claim your prize. Race against the clock and see if you have what it takes to figure out PuzzleBang's Suspicious Garage!",
        isVirtual: false,
        imageUrl: 'https://google.com',
    ...
    },
    {
        ...
        points: 10,
        description:
            'Looking for a career in the tech industry? Stop by Siebel to meet representatives from top tier technology companies. No need to dress formal, just bring your best self!\n\nFeatured companies: HRT, Caterpillar, Qualcomm, Aechelon Technology, John Deere, Everfox, Cloudflare, State Farm.',
        isVirtual: false,
        imageUrl: 'https://google.com',
    ...
    },
    {
        ...
        attendanceCount: 27,
        eventType: 'SPEAKER',
        tags: ['Art/Media', 'AI', 'Career Readiness'],
    },
    {
        ...
        attendanceCount: 40,
        eventType: 'CORPORATE',
        tags: ['Networking', 'Company Talk', 'Interactive Events', 'AI'],
    },
    {
        ...
        points: 10,
        description:
            'Robotics today is more prolific than it has ever been. There are real robots in real spaces, from airport guides to self-driving vehicles. In this talk, I argue that in our current era of ubiquitous robotics, the study of human robot interaction is not only more relevant than ever but also absolutely necessary before any robot deployment makes it into the real world.',
        isVirtual: false,
        imageUrl: 'https://google.com',
        location: 'Siebel 2405',
        isVisible: true,
    ...
    },
    {
        ...
        points: 10,
        description:
            'As autonomous vehicles transition from concept to reality, they promise to revolutionize the very fabric of society. This talk explores the societal implications of this technology—from reshaping urban landscapes and reducing traffic fatalities to redefining employment and ethical decision-making. We’ll delve into the opportunities and challenges that lie ahead, questioning how this technological leap will impact equity, privacy, and the way we live, work, and connect.',
        isVirtual: false,
        imageUrl: 'https://google.com',
        location: 'Siebel 2405',
        isVisible: true,
        attendanceCount: 26,
        eventType: 'SPEAKER',
        tags: ['Research', 'HCI', 'Autonomous Vehicles', 'Ethics'],
    },
    {
    ...
    },
    {
        ...
        points: 10,
        description:
            'This talk examines the potential impact and benefits of Generative AI on engineering education. The audience will be introduced to our work on an AI-powered personalized learning system that enhances student engagement and feedback. Using large language models, the system generates concept maps that capture key topics, principles, and relationships in a course. Linked with student submissions, these maps form a knowledge graph that tracks progress, delivers tailored feedback, highlights strengths and areas for growth, and recommends targeted resources and practice.',
        isVirtual: false,
        imageUrl: 'https://google.com',
        location: 'Siebel 2405',
        isVisible: true,
...
export default function Schedule() {
    ...
    const selectedDayIndex = Math.max(Object.keys(eventsByDay).indexOf(selectedDay || '') + 1, 1);
    ...
    const handleLoadEvents = useCallback(() => {
        try {
            ...
            const dates = Object.keys(grouped).map((key) => {
                const date = moment(key + ' ' + moment().year(), 'ddd M/D YYYY').startOf('day');
                return { key, date };
            });
    ...
    const updateCurrentAndNext = useCallback(() => {
        ...
        const sorted = all.sort((a, b) => moment(a.startTime).diff(moment(b.startTime)));
...
function formatEventRange(startIso: string, endIso: string): string {
    ...
    const endLabel = start.isSame(end, 'day') ? end.format('h:mma') : formatEventTime(endIso);
    ...
    return (
        <Box flex={1} h="100%" py={0}>
            <HStack
                ...
                boxShadow="md"
            >
                <Text fontSize={'3xl'} color="#8A8A8A" fontFamily="ProRacingSlant" my={0}>
                    Lap
                </Text>
                <HStack gap={0}>
                    <Text
...
function RaceTrackSection({
    ...
    return (
        <Flex
            ...
            alignItems={'center'}
        >
            <Box display="flex" flexDir={'column'} flex={1} borderRadius="lg" h="100%">
                <Spacer flex={1} />
                <Box
                    w="100%"
                    transform={{
                ...
                >
                    ...
                    >
                        <Text fontSize="2xl" color="white" fontFamily="ProRacingSlant" my={0}>
                            R|P Radio
                        </Text>
                        <AudioVisualizer />
                    </Flex>
                ...
                <Flex direction="column" flex={1} w="100%" gap={0}>
                    <Flex alignItems={'center'} gap={2}>
                        <Box
                            ...
                            borderRadius="full"
                        />
                        <Text fontSize={compact ? 'md' : 'sm'} color="white" fontFamily="ProRacing">
                            {event.name}
                        </Text>
                    </Flex>
                    {!compact ? (
