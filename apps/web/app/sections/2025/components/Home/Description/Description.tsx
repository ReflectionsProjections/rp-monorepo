        ...
        >
            ...
            <Box flexBasis={{ lg: '50%' }} maxW={{ lg: '52vw' }} zIndex={1}>
                ...
                >
                    ...
                    >
                        Start your engines and step into the driver’s seat at the Midwest’s largest
                        student-run technology conference!{' '}
                        <Box
                            as="img"
                            lineHeight={0}
                    ...
                    >
                        Hosted at the Siebel Center for Computer Science at UIUC from September
                        16–20, we’ll race towards the future with guest speakers, tech talks, a
                        career fair, free merch, and more. At R|P, you’ll gear up for the road
                        ahead.{' '}
                        <Box
                            as="img"
