...
function MagicLinkSentPage({ email, onBack }: { email: string; onBack: () => void }) {
    ...
    return (
        <VStack spacing={6} maxW="400px" px={4}>
            ...
            <Text fontSize="16" fontFamily="Nunito" fontWeight="300" opacity={0.8}>
                We sent a magic link and a 6-digit code to your email address. Click the link, or
                enter the code below to log in to the Resume Book.
            </Text>
            <Formik
                initialValues={{ code: '' }}
                validationSchema={yup.object({
