...
import { Button, Popover, PopoverContent, PopoverTrigger, VStack } from '@chakra-ui/react';
import { educationLevels, graduationDates, majors, minors, employmentOpportunities } from '@app';
