        ...
        <>
            ...
            >
                ...
                >
                    ...
                    <ResumeBookFooter
                        startIndex={
                            resumeDataPaginationHook.pagination.startIndex
                        }
                        endIndex={resumeDataPaginationHook.pagination.endIndex}
                        allFilteredResumes={
                            resumeDataPaginationHook.resumeData
                                .allFilteredResumes
                        }
                        filteredResumes={
                        ...
                        displayedPage={
                            resumeDataPaginationHook.pagination.displayedPage
                        }
                        handlePageChange={
                            resumeDataPaginationHook.pagination.handlePageChange
                        }
                        handleNext={
                            resumeDataPaginationHook.pagination.handleNext
                        }
                        handlePrevious={
                            resumeDataPaginationHook.pagination.handlePrevious
                        }
                    />
                </Box>
            </Flex>
