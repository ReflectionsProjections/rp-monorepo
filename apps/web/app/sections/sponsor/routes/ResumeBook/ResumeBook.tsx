import { Box, Flex, useColorModeValue, useMediaQuery, useToast } from '@chakra-ui/react';
...
export function ResumeBook() {
    ...
    return (
        <>
            <Flex flexDirection={'column'} h="100dvh" maxH="100dvh" bgColor="gray.200">
                ...
                >
                    ...
                    <ResumeBookFooter
                        ...
                        allFilteredResumes={resumeDataPaginationHook.resumeData.allFilteredResumes}
                        filteredResumes={resumeDataPaginationHook.resumeData.filteredResumes}
                        ...
                        handlePageChange={resumeDataPaginationHook.pagination.handlePageChange}
