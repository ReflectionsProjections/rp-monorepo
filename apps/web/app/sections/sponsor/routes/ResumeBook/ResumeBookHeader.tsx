            ...
            <Flex w="100%" gap={2} flexWrap={"wrap"}>
                ...
                <Flex gap={2}>
                    <FilterModal
                        ...
                        filtering={
                            filtering satisfies FilterModalProps["filtering"]
                        }
                    />
                    ...
                    <Popover>
                        <PopoverTrigger>
                            <Button
                                ...
                                transition="border background-color color 0.3s ease"
                                leftIcon={
                                    isMediumScreen ? <FaDownload /> : undefined
                                }
                            >
                        ...
                        >
                            ...
                            <Button
                                mr={2}
                                onClick={() =>
                                    void exportResumes.handleDownloadResumes()
                                }
                                border="1px solid transparent"
                                _hover={{
                                    border: "1px solid black",
                                ...
                                color={"white"}
                                isDisabled={
                                    selection.selectedResumes.length < 1
                                }
                                transition="border background-color color 0.3s ease"
                            ...
                            <Button
                                onClick={() =>
                                    void exportResumes.downloadResumesCSV(true)
                                }
                                border="1px solid transparent"
                                _hover={{
                                    border: "1px solid black",
                            ...
                            <Button
                                onClick={() =>
                                    void exportResumes.downloadResumesCSV(false)
                                }
                                border="1px solid transparent"
                                _hover={{
                                    border: "1px solid black",
