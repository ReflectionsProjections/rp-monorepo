...
import { FaBook, FaFileDownload, FaGraduationCap, FaUniversity, FaUser } from 'react-icons/fa';
import { FaArrowDownWideShort, FaArrowUpWideShort, FaUserTie } from 'react-icons/fa6';
...
const Column = ({ id, sortColId, sortDirection, name, icon, boxSize = 3, onSort }: ColumnProps) => {
    return (
        <GridItem
            _groupHover={{
        ...
        >
            ...
            >
                ...
                {sortColId === id && (
                    <Icon
                        as={sortDirection === 'asc' ? FaArrowUpWideShort : FaArrowDownWideShort}
                        boxSize={4}
                        color="gray.600"
                        ml={2}
                    />
