import { Box, Flex, HStack, IconButton, Image, Text, Tooltip, VStack } from '@chakra-ui/react';
...
const MajorsMinorsList: React.FC<MajorsMinorsListProps> = ({ degreeType, majors, minors }) => {
    return (
