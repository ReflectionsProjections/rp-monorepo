                    ...
                    >
                        ...
                        <Link href="https://www.aechelon.com" isExternal>
                            <Image
                                ...
                                _hover={{
                                    transform:
                                        "translateX(-50%) scale(1.5) translateY(-15px)",
                    ...
                    >
                        ...
                        <Link href="https://www.aechelon.com" isExternal>
                            <Image
                                ...
                                _hover={{
                                    transform:
                                        "translateX(-50%) scale(1.3) translateY(-12px)",
                                    filter: getGlowFilter(sponsorGlows.aech),
                                    cursor: "pointer",
                                    outline: "none",
                                }}
                ...
                >
                    <SimpleGrid columns={1} spacing={10} w="100%">
                        ...
                        >
                            <Link href="https://www.caterpillar.com" isExternal>
                                <Image
                                    src="/site/sponsors/car_images/caterpillar.svg"
                                    h="80px"
                                    w="auto"
                                    filter={getSubtleGlowFilter(
                                        sponsorGlows.cat,
                                    )}
                                    transition="all 0.3s ease"
                                    _hover={{
                        ...
                        >
                            ...
                            >
                                <Image
                                    src="/site/sponsors/car_images/deere.png"
                                    h="100px"
                                    w="auto"
                                    filter={getSubtleGlowFilter(
                                        sponsorGlows.deere,
                        ...
                        >
                            ...
                            >
                                <Image
                                    src="/site/sponsors/car_images/hrt.svg"
                                    h="80px"
                                    w="auto"
                                    filter={getSubtleGlowFilter(
                                        sponsorGlows.hrt,
                        ...
                        >
                            <Link href="https://www.qualcomm.com/" isExternal>
                                <Image
                                    src="/site/sponsors/car_images/qualcomm.png"
                                    h="50px"
                                    w="auto"
                                    filter={getSubtleGlowFilter(
                                        sponsorGlows.qual,
                        ...
                        >
                            <Link href="https://www.aechelon.com" isExternal>
                                <Image
                                    src="/site/sponsors/car_images/aechelon.png"
                                    h="110px"
                                    w="auto"
                                    filter={getSubtleGlowFilter(
                                        sponsorGlows.aech,
