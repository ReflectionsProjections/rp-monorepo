...
import { defaultActiveDay, groupEventsByDay, orderDays } from './schedule-utils';
...
export default function Schedule() {
    ...
    const defaultDay = useMemo(() => defaultActiveDay(orderedDays), [orderedDays]);

    const activeDay = selectedDay && orderedDays.includes(selectedDay) ? selectedDay : defaultDay;
    const dayEvents = activeDay ? (eventsByDay[activeDay] ?? []) : [];

    return (
        <>
            <Box id="schedule" position="relative" w="100%" overflow="hidden" bg="#100E0E">
                <Box
                    position="relative"
                    w="100%"
                    mx="auto"
                ...
                >
                    ...
                    >
                        ...
                        >
                            <ScheduleScreen events={dayEvents} onSelectEvent={setSelectedEvent} />
                        </Box>
