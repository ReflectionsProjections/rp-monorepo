...
import { ComboBox, FileDrop, FlagCard, LinksInput, OtherInput, PillGroup } from './controls';
import {
    CYAN,
    FieldError,
    FieldLabel,
...
const GENDER_OPTIONS = ['Man', 'Woman', 'Non-binary', 'Prefer not to say', GENDER_SELF_DESCRIBE];
...
export const sectionComplete = (index: number, values: RegistrationValues): boolean => {
    switch (index) {
        case 0:
            return values.name !== '' && values.gender !== '';
        case 1:
            return values.allergies.length > 0 || values.dietaryRestrictions.length > 0;
        case 2:
            return (
                values.school !== '' &&
        ...
        <Box {...glassCardStyles} overflow="hidden" mb="14px">
            ...
            >
                <Flex
                    ...
                    borderRadius="9px"
                    border="1px solid"
                    borderColor={active ? 'rgba(239,83,158,0.6)' : 'rgba(252,242,246,0.2)'}
                    align="center"
                    justify="center"
...
export const InterestsSection = () => {
    ...
    return (
        <>
            ...
            <Box>
                <FieldLabel isRequired>What kinds of events are you interested in?</FieldLabel>
                <PillGroup
                    multi
                    options={TAG_OPTIONS}
                    value={values.tags}
            ...
            <SimpleGrid columns={{ base: 1, md: 2 }} spacing="14px">
                <FlagCard
                    ...
                    onToggle={() =>
                        void setFieldValue('isInterestedPuzzleBang', !values.isInterestedPuzzleBang)
                    }
                />
                <FlagCard
                    title="MechMania"
                    ...
                    onToggle={() =>
                        void setFieldValue('isInterestedMechMania', !values.isInterestedMechMania)
                    }
                />
            </SimpleGrid>
        </>
...
export const CareerSection = () => {
    const { values, setFieldValue, errors, touched } = useFormikContext<RegistrationValues>();
        ...
        <>
            ...
            <Box>
                ...
                <Text fontSize="12.5px" lineHeight="1.6" color={MUTED} mt="11px">
                    Your resume will be shared with our corporate sponsors. You may return to this
                    page at any time to update it.
                </Text>
            </Box>
