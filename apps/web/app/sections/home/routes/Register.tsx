...
const Register = () => {
    ...
    const Background = () => {
        ...
        const finalOpacity =
            useBreakpointValue({ base: 0.2, "2xl": 0.4 }) ?? 0.2
        ...
        const image1ShadowOpacity = useTransform(
            scrollYProgress,
            [0, 0.5],
            [1, 0],
        )
        const image2ShadowOpacity = useTransform(
            scrollYProgress,
            [0.5, 1],
            [0, 1],
        )
    ...
    const ConfirmationScreen = () => (
        ...
        /> */}
                ...
                <Text
                    ...
                    textAlign="center"
                >
                    Look out for a confirmation email from R|P, and download the
                    app today!
                </Text>
                <HStack
                    spacing={6}
