            ...
            <VStack spacing={8} textAlign="center" maxW="600px" px={8}>
                ...
                <VStack spacing={4}>
                    ...
                    <Text
                        ...
                        opacity="0.9"
                    >
                        Sorry, this page didn't make it to the finish line. It
                        might have been moved, deleted, or you took a wrong turn
                        on the URL track.{" "}
                    </Text>
                    <Text
                        fontSize="lg"
                        ...
                        opacity="0.9"
                    >
                        Don't worry—no penalty for cutting the corner this
                        time.{" "}
                    </Text>
                </VStack>
