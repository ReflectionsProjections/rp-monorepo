...
function EmailForm({ onSent }: { onSent: (email: string) => void }) {
    ...
    return (
        <AuthCard title="Sign in or register">
            <Text fontFamily={BODY_FONT} fontWeight={500} color={TEXT_COLOR} opacity={0.8}>
                Enter your email and we&rsquo;ll send you a link. No password needed &mdash; the
                same link works whether you already have an account or you&rsquo;re new here.
            </Text>
    ...
    return (
        <AuthCard title="Check your email">
            <Text fontFamily={BODY_FONT} fontWeight={500} color={TEXT_COLOR} opacity={0.85}>
                ...
                . Open the link, or enter the code below &mdash; both expire in about 10 minutes.
            </Text>
            ...
            <Formik
                ...
                onSubmit={({ code }, { setSubmitting }) => {
                    setSubmitError('');
                    api.post('/auth/magic-links/verify-code', {
                        email,
                        code,
                        client: 'web',
                    })
