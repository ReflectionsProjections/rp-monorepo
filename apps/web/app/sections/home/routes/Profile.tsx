    ...
    const handleLoadAuthData = async () => {
        ...
        if (role.userId) {
            ...
            if (now > rpStartDate && now < rpEndDate) {
                ...
                const hasPriority =
                    newAttendee[
                        `hasPriority${todayShort}` as keyof typeof newAttendee
                    ] || false
        ...
        >
            <Box px={6} pt={6} pb={4} maxW="400px" w="100%" mx="auto">
                ...
                <Text
                    ...
                    mb={2}
                >
                    Level up your prize tier to unlock more rewards at the end
                    of the event.
                </Text>
                ...
                <Text
                    ...
                    mb={2}
                >
                    Attend events and activities to earn points, which advance
                    your prize tier.
                </Text>
