            ...
            <div className="app-wrapper">
                ...
                <div className="app-container">
                    <div className="gif-container">
                        <img src="/hype/RPREC.gif" alt="Centered GIF" className="centered-gif" />
                    </div>
                    <div className="title-container">
                        <HStack justifyContent="center" spacing="8px" textAlign="center" ml="16px">
                            <Text
                        ...
                        <VStack spacing="12px" mt={isMobile ? '16px' : '2px'}>
                            ...
                            <Box
                                sx={{
                                    p: '2px',
                                    borderRadius: '999px',
                                    background: 'linear-gradient(90deg, #b9b8b8 0%, #888888 100%)',
