...
export const colorProfiles: ColorProfile[] = [
    ...
    },
    {
        ...
        gradient: 'linear-gradient(to-r,rgba(0, 0, 0, 0.01),rgba(0, 150, 255, 0.4))',
        primary: '#0096FF',
        secondary: '#00D4FF',
        accent: '#B2F5EA',
    },
    {
        ...
        gradient: 'linear-gradient(to-r,rgba(26, 43, 34, 0.06),rgba(0, 128, 0, 0.4))',
        primary: '#1A2B22',
        secondary: '#008000',
        accent: '#38A169',
    },
    {
        ...
        gradient: 'linear-gradient(to-r,rgba(0, 0, 0, 0.14),rgba(128, 0, 255, 0.4))',
        primary: '#8000FF',
        secondary: '#A259FF',
        accent: '#F687B3',
    },
...
export const ColorThemeProvider: React.FC<ColorThemeProviderProps> = ({ children }) => {
    const [currentProfile, setCurrentProfileState] = useState<ColorProfile>(() => {
        ...
        const savedProfile = colorProfiles.find((profile) => profile.id === savedProfileId);
