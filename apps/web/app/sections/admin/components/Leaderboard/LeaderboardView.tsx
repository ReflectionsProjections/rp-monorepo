import { Box, Flex, Stack, StackDivider, Text, useColorModeValue } from '@chakra-ui/react';
    ...
    return (
        ...
        >
            ...
            <Box flex={2} textAlign="center">
                <Text as="b" fontSize="lg" color={isQualified ? qualifiedText : normalText}>
                    {user.points} pts
                </Text>
            </Box>
        </Flex>
...
const LeaderboardCardSkeleton: React.FC = () => (
    <Flex justifyContent="space-between" alignItems="center" gap={4} py={0} opacity={0.7}>
        <Box flex={4}>
        ...
        <Box flex={{ base: 2, lg: 4, xl: 6 }}>
            <Box height="24px" bg="gray.200" borderRadius="md" width="90%" minW="60px" />
        </Box>
        <Box flex={2}>
            <Box height="24px" bg="gray.200" borderRadius="md" width="40px" mx="auto" />
        </Box>
    </Flex>
);
...
const LeaderboardView: React.FC<{
    ...
    const breakpoint = useMemo(() => minimumPointsThreshold, [minimumPointsThreshold]);
