        ...
        >
            ...
            <Stack spacing={4} textAlign="left" w="100%" mt={4}>
                ...
                <Stack spacing={2} mt={3}>
                    ...
                    >
                        <Text color={textColor} fontSize="xs">
                            TIER1+: {currentTier1Count} →{" "}
                            <Text as="b">{newTier1Count}</Text>
                        </Text>
                        <Text color={textColor} fontSize="xs">
                            TIER2+: {currentTier2Count} →{" "}
                            <Text as="b">{newTier2Count}</Text>
                        </Text>
                    </Stack>
                    <Stack
                        direction="row"
                    ...
                    >
                        <Text color={textColor} fontSize="xs">
                            TIER3+: {currentTier3Count} →{" "}
                            <Text as="b">{newTier3Count}</Text>
                        </Text>
                        <Text color={textColor} fontSize="xs">
                            TIER4: {currentTier4Count} →{" "}
                            <Text as="b">{newTier4Count}</Text>
                        </Text>
                    </Stack>
                </Stack>
                ...
                >
                    ...
                    <br />({percentageOfTotal}% of total attendees,{" "}
                    {percentageWithPoints}% of attendees with points)
                </Text>
            </Stack>
        </Stack>
    )
