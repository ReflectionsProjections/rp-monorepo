...
const SpeakerCard: React.FC<SpeakerCardProps> = ({ speaker, updateSpeakers }) => {
...
export const SpeakerCardSkeleton: React.FC<SpeakerCardSkeletonProps> = ({ animation = true }) => {
        ...
        <Card sx={mirrorStyles} w="sm">
            <CardBody>
                <Stack mt="6" spacing="3" alignItems="center">
                    <Skeleton height="200px" width="100%" speed={speed} borderRadius="lg" />
                    <Skeleton height="24px" width="60%" speed={speed} />
                    <Skeleton height="20px" width="100%" borderRadius="full" speed={speed} />
                    <SkeletonText noOfLines={4} spacing="2" width="85%" speed={speed} />
                </Stack>
            </CardBody>
            <CardFooter>
                <Flex justifyContent="space-between" width="100%">
                    <Skeleton height="36px" width="80px" borderRadius="md" speed={speed} />
                    <Skeleton height="36px" width="80px" borderRadius="md" speed={speed} />
                </Flex>
            </CardFooter>
        </Card>
