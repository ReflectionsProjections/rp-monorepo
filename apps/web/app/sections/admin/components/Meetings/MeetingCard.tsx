...
const MeetingCard: React.FC<MeetingCardProps> = ({ meeting, updateMeetings }) => {
            ...
            <CardBody>
                <Stack mt="6" spacing="3">
                    ...
                    <Badge
                        borderRadius="full"
                        px="2"
                        colorScheme={meeting.committeeType === 'FULL TEAM' ? 'pink' : 'blue'}
                    >
...
export const MeetingCardSkeleton: React.FC<MeetingCardSkeletonProps> = ({ animation = true }) => {
