...
import { Box, Button, Flex, Image, Text, VStack, Center, HStack, Heading } from '@chakra-ui/react';
import { magicLinkSignIn } from '@app';

export default function Login() {
    return (
        <Flex direction="column" alignItems="center" justifyContent="center" w="100%" h="100%">
            <Center>
                <Image
            ...
            <VStack spacing={4} mb={8}>
                ...
                <Text fontFamily={'Nunito'} fontSize={'40'} as="h1" size="xl" fontWeight={'900'}>
                    Admin Site
                </Text>
            </VStack>
