                    ...
                    {currentAssignments.length > 0 && (
                        <HStack spacing={2}>
                            ...
                            <Badge colorScheme="orange" variant="subtle">
                                {currentAssignments.filter((m) => !m.acknowledged).length} Pending
                            </Badge>
                        </HStack>
                    )}
                </Flex>
                                            ...
                                            >
                                                <Box position="relative">
                                                    ...
                                                    <IconButton
                                                        ...
                                                        h="20px"
                                                        onClick={() =>
                                                            void handleAssignStaff(member.email)
                                                        }
                                                        isLoading={isLoading}
                                                        _hover={{ bg: 'green.600' }}
                                                    />
            ...
            >
                <AlertDialogOverlay>
                    <AlertDialogContent>
                        ...
                        <AlertDialogBody>
                            Are you sure you want to unassign {staffToUnassign?.name} from this
                            shift?
                        </AlertDialogBody>
