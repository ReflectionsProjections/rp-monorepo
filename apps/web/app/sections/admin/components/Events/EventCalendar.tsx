...
const EventCalendar: React.FC<EventCalendarProps> = ({ events, updateEvents }) => {
    ...
    useEffect(() => {
        if (selectedEvent) {
            const updatedEvent = events.find((event) => event.eventId === selectedEvent.eventId);
            if (updatedEvent) {
                    ...
                    <ModalBody pb={6}>
                        {selectedEvent && (
                            <VStack spacing={4} align="stretch">
                                ...
                                <Flex gap={2} mt={4}>
                                    <EditModal event={selectedEvent} updateEvents={updateEvents} />
                                    <DeleteModal
                                        event={selectedEvent}
