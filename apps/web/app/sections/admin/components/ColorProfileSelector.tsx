...
import { Box, Text, VStack, HStack, useColorModeValue, Divider } from '@chakra-ui/react';
...
const ColorProfileSelector: React.FC<ColorProfileSelectorProps> = ({ onClose }) => {
        ...
        <VStack spacing={2} align="stretch" minW="200px">
            ...
            {colorProfiles.map((profile) => (
                <Box
                    ...
                    borderRadius="md"
                    border="1px solid"
                    borderColor={currentProfile.id === profile.id ? 'blue.300' : 'transparent'}
