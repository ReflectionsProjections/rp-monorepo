...
const MerchModal: React.FC<MerchModalProps> = ({
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose}>
            ...
            <ModalContent>
                <ModalHeader>
                    Redeem Merch for {selectedAttendee?.name}
                </ModalHeader>
                <ModalCloseButton />
                <ModalBody pb={6}>
                    ...
                    {data?.redeemableTiers?.length ? (
                        <>
                            <Text mb={4}>
                                This attendee is eligible for the following
                                merch items. Select which items to redeem:
                            </Text>
                        ...
                        <Text>
                            {selectedAttendee?.name} has no merch items
                        ...
                        {!!data?.redeemableTiers?.length && (
                            <Button
                                ...
                                isDisabled={
                                    ...
                                    Object.values(merchToRedeem).every(
                                        (selected) => !selected,
                                    )
                                }
                            >
