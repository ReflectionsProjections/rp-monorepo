        ...
        const request = api
            ...
            .then((response) => {
                mutateStaff(
                    (previous) =>
                        previous?.map((member) =>
                            member.email === response.data.email
                                ? response.data
                                : member,
                        ) ?? [response.data],
                )
