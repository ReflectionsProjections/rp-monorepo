...
import { ColorThemeProvider, useColorTheme } from '@app/sections/admin/contexts/ColorThemeContext';
...
const MainContent = () => {
    ...
    const hasAdminSectionAccess = roles.includes('STAFF') || roles.includes('ADMIN');
    ...
    return (
        ...
        >
            ...
            <Box
                ...
                maxH={!authorized ? { base: 'calc(100vh - 100px)', md: '100vh' } : undefined}
            >
