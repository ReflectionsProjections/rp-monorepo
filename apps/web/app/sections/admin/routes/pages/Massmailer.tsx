...
function EmailMaker() {
        ...
        api.get("/subscription/lists")
            ...
            .catch(() => {
                toast({
                    ...
                    description:
                        "Try reloading, signing in again, or checking the api",
                    status: "error",
                    duration: 4000,
                    isClosable: true,
                })
    ...
    const sendMassmail = (
        ...
        if (values.isMobileNotification) {
            ...
            const request = api
                .post(
                    path("/notifications/topics/:topic", { topic }),
                    notifData,
                )
                .then(async () => {
                    helpers.resetForm()
            ...
            toast.promise(request, {
                ...
                error: {
                    title: "Failed to send notification. Try again soon!",
                },
    ...
    return (
        ...
        >
            {({
                ...
                const markdownHtml = generateHtmlEmail(
                    values.body,
                    values.template,
                )
