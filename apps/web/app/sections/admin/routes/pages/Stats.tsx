...
function Stats() {
    ...
    const sortedDietaryRestrictionCounts = useMemo(() => {
        ...
        return Object.entries(
            dietaryRestrictions?.dietaryRestrictionCounts,
        ).sort()
    }, [dietaryRestrictions])
                        ...
                        <StatLabel>
                            {tierCountsLoading ? (
                                ...
                                >
                                    ...
                                    <Text>
                                        beanies: {tierCountsData?.TIER4 ?? 0}
                                    </Text>
                                </Stack>
                            )}
                        </StatLabel>
                    ...
                    <Stat sx={mirrorStyles}>
                        ...
                        <StatLabel>
                            {prizesGivenLoading ? (
                                ...
                                >
                                    <Text>
                                        shirts: {prizesGivenData?.TIER1 ?? 0}
                                    </Text>
                                    <Text>
                                        key chains:{" "}
                                        {prizesGivenData?.TIER2 ?? 0}
                                    </Text>
                                    <Text>
                                        squishies: {prizesGivenData?.TIER3 ?? 0}
                                    </Text>
                                    <Text>
                                        beanies: {prizesGivenData?.TIER4 ?? 0}
                                    </Text>
                                </Stack>
                            )}
                        </StatLabel>
                    ...
                    <Stat sx={mirrorStyles}>
                        ...
                        <StatNumber mt={1}>
                            {eventAttendanceLoading ? (
                                ...
                                <Text>
                                    {eventAttendanceData?.attendanceCount ?? 0}
                                </Text>
                            )}
                        </StatNumber>
                    </Stat>
                        ...
                        <Bar
                            data={
                                dietaryRestrictionsLoading
                                    ? { labels: [], datasets: [] }
                                    : {
                                          labels: sortedAllergyCounts?.map(
                                              (entry) => entry[0],
                                          ),
                                          datasets: [
                                              {
