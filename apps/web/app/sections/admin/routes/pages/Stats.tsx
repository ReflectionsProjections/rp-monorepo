...
function Stats() {
    ...
    const { data: eventAttendanceData, isLoading: eventAttendanceLoading } = usePolling(
        path('/stats/event/:EVENT_ID/attendance', { EVENT_ID: eventId }),
        authorized,
    );
    const { data: numAttendedEventsData, isLoading: numAttendedEventsLoading } = usePolling(
    ...
    const { data: dietaryRestrictions, isLoading: dietaryRestrictionsLoading } = usePolling(
            ...
            <StatGroup display="flex" flexDir="column" alignItems="center" gap={4}>
                ...
                <HStack w="100%" gap={4}>
                    ...
                    <Stat sx={mirrorStyles}>
                        ...
                        >
                            ...
                            <Text display={{ base: 'none', sm: 'block', md: 'none', lg: 'block' }}>
                                events:
                            </Text>
                        </StatLabel>
                        <StatNumber mt={1}>
                ...
                <HStack w="100%" gap={4}>
                    <Stat sx={mirrorStyles}>
                        ...
                        <StatNumber>
                            {numAttendedEventsLoading ? '—' : (numAttendedEventsData?.count ?? 0)}
                        </StatNumber>
                    </Stat>
                    <StatCard
                ...
                <Card sx={mirrorStyles} w="90%">
                    ...
                    <StatGroup>
                        <Stat>
                            ...
                            <StatNumber>
                                {dietaryRestrictionsLoading ? '—' : dietaryRestrictions?.allergies}
                            </StatNumber>
                        </Stat>
                        <Stat>
