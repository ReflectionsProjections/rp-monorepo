                ...
                if (axios.isAxiosError(err) && err.response?.data) {
                    ...
                    if (code === "AlreadyCheckedIn") {
                        toast({
                            ...
                            description:
                                "You have already checked into this meeting!",
                            status: "info",
                            duration: 5000,
                            isClosable: true,
                        })
                        ...
                        toast({
                            ...
                            description:
                                "The specified meeting ID does not exist.",
                            status: "error",
                            duration: 5000,
                            isClosable: true,
                        })
                ...
                <VStack spacing={6} align="stretch">
                    ...
                    {status === "alreadyCheckedIn" && (
                        <Box textAlign="center">
                            ...
                            <Text mt={2}>
                                No need to worry, you're counted.
                            </Text>
                        </Box>
                    )}
                    ...
                    {status === "expired" && (
                        <Box textAlign="center">
                            ...
                            <Text mt={2}>
                                This check-in link has expired. Please contact
                                an admin for help.
                            </Text>
                        </Box>
                    )}
                    ...
                    {status === "notFound" && (
                        <Box textAlign="center">
                            ...
                            <Text mt={2}>
                                The specified meeting ID does not exist. Please
