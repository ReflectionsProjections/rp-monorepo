...
// Components
const BenefitCard: React.FC<BenefitItem> = ({ icon, title, description, bgColor }) => {
    const colorValue = useColorModeValue('gray.100', 'gray.700');
    const bg = bgColor || colorValue;
    return (
        <VStack spacing={4} bg={bg} p={8} borderRadius="lg" textAlign="center" align="center">
...
const ContactItem: React.FC<{ placeholder?: boolean }> = ({ placeholder = true }) => {
    return (
        <Flex bg="gray.300" borderRadius="full" h={24} w={24} align="center" justify="center">
