import { Box, Flex, Heading, Text, Container, VStack, Button, Image } from '@chakra-ui/react';
        ...
        <Box data-label="sponsor section" minH="40vh" overflowX="hidden" py={10}>
            <Container maxW="container.xl">
                ...
                >
                    ...
                    <Box transform="rotate(15deg)" transformOrigin="center" mr="-12px" mt="-24px">
                        {/* OUTER BACKDROP */}
                        <Box bg="#B8B8B8" p={4}>
                            {/* INNER BACKDROP */}
                            <Box bg="#D5D5D5" p={6}>
                    ...
                    <Box transform="rotate(-15deg)" transformOrigin="center" ml="-12px" mt="-40px">
                        {/* OUTER BACKDROP */}
                        <Box bg="#B8B8B8" p={4}>
                            {/* INNER BACKDROP */}
                            <Box bg="#D5D5D5" p={6}>
