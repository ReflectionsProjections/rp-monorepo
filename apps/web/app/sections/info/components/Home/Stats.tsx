    ...
    return (
        <>
            ...
            <Box
                position="relative"
                minH="40vw"
                backgroundImage="url('/info/build_future.svg')"
                        ...
                        >
                            <VStack align="flex-start" p={8} spacing={4}>
                                ...
                                <Text
                                    ...
                                    transition="all 0.3s ease-in-out"
                                >
                                    Reflections | Projections is the Midwest's{" "}
                                    <em>largest</em> student-run conference.
                                    Meet industry and academic leaders, learn
                                    new skills, and connect with other students!
                                </Text>
                            </VStack>
                        </Box>
                    </Flex>
