...
const faqData = [
    {
        ...
        answer: 'R|P is a technology conference that brings together students and professionals to explore cutting-edge developments in computer science, programming, and technology innovation.',
    },
    {
        question: 'Who can attend R|P?',
        answer: 'The conference is open to students, professionals, researchers, and anyone interested in technology. We welcome attendees from all backgrounds and experience levels.',
    },
    {
        question: 'When is the event?',
        answer: "R|P typically takes place annually in the spring semester. Check our website for the exact dates and schedule for this year's conference.",
    },
    {
        question: 'How much does it cost?',
        answer: 'Registration fees vary by attendee type. Students often receive discounted rates, and some events may be free. Visit our registration page for current pricing.',
    },
];
    ...
    <VStack spacing={4} align="stretch" h="100%" justify="flex-start" pt={4}>
        <Box>
            <Flex align="center" mb={3}>
                <Text fontSize="xl" fontWeight="bold" color={textColor} lineHeight="1.3" flex="1">
                    {question}
                </Text>
        ...
        return (
            ...
            >
                ...
                >
                    ...
                    <Button size="lg" px={8} colorScheme="blue" onClick={() => setOpen((o) => !o)}>
                        {open ? 'Close' : 'Open'}
                    </Button>
                </Box>
