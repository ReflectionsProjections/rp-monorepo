...
const CircularCarousel: React.FC<CircularCarouselProps> = ({ items, centerItem }) => {
    ...
    const handleItemClick = (index: number) => {
        ...
        const counterClockwiseSteps = (activeIndex - index + totalItems) % totalItems;

        const shouldGoClockwise = clockwiseSteps <= counterClockwiseSteps;
        const stepsToTake = shouldGoClockwise ? clockwiseSteps : counterClockwiseSteps;
    ...
    const getItemStyle = (index: number, isMobile: boolean = false) => {
        ...
        return {
            ...
            boxShadow: isFrontItem ? '0 10px 30px rgba(0,0,0,0.4)' : '0 5px 15px rgba(0,0,0,0.2)',
        };
    };
    ...
    return (
        <Flex
            ...
            pt={{ base: 4, md: 8 }}
        >
            <Box position="relative" w="100%" h={{ base: '400px', md: '500px' }} mx="auto">
