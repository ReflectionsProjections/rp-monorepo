            ...
            <Container maxW="container.xl">
                <Flex direction={{ base: 'column', md: 'row' }} mb={16} align="center">
                    <VStack flex={1} align="flex-start" p={4} spacing={4}>
                        ...
                        <Text fontSize="lg">
                            RP is a week-long ipsum dolor sit amet, consectetur adipiscing elit, sed
            ...
            >
                <Box
                    ...
                    _before={{
                        ...
                        width: '100%',
                        height: '30%',
                        background: 'linear-gradient(45deg, #9CA3AF 0%, #6B7280 50%, #4B5563 100%)',
                ...
                <Container maxW="container.xl" position="relative" zIndex={10} py={16}>
                    ...
                    >
                        ...
                        >
                            ...
                            <Text fontSize="3xl" fontStyle="italic" lineHeight="6" color="gray.600">
