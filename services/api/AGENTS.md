...
-   Do not commit `testing/.supabase-test.env`; it is generated by `services/db` for local API tests, contains generated local test JWT material, and is gitignored.
